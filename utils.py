...
def parse_arguments():
    ...
    argparser.add_argument('--num_heads', type=int, default=8, help='Model number of attention heads')
    ...
    argparser.add_argument('--lr_max', type=float, default=9e-4, help='Maximum stepsize')
